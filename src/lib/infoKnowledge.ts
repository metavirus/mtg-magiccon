...
export type InfoSource = { label: string; url?: string; detail?: string; capturedAt?: string }
export type InfoFact = { label: string; value: string }
export type InfoTopic = { id: string; topic_key: string; title: string; concise_answer: string; facts: InfoFact[]; sources: InfoSource[]; updated_at: string }
...
export const previewInfoTopics: InfoTopic[] = [
