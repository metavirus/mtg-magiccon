...
- `after:2026/06/01 (MagicCon OR "Magic Con" OR mtgfestivals OR ReedPop OR "Leap Conventions" OR leapevent OR Pastimes)`
- `after:2026/06/01 ("MagicCon: Atlanta" OR "Atlanta 2026")`
- `after:2026/06/01 (subject:(confirmation OR receipt OR order OR ticket OR badge) (MagicCon OR "Leap Conventions" OR leapevent))`
