...
See `PRE_TICKETED_PLAY_HYPOTHETICAL_HYDRATION.md` for a bracketed paper exercise imagining this early state. It is an exploration artifact only, not a seed plan, schema, monitor, or production-data proposal.

### Ticketed-play planning usefulness

When ticketed play appears, the app's center of gravity shifts from watch-duty relief to contention management and information translation. Leap remains the source for purchasing and its own schedule, but the app should become the place where the owner understands what each event means, compares tradeoffs, and decides what is worth committing to.

The first value prop is turning dense event listings into decision objects. A single event description may contain format nomenclature, product contents, price, duration, registration requirements, Companion guidance, prize structure, refundability, team rules, links, and buried gotchas. The app should preserve source wording but present a readable brief: what kind of event it is, whether it fits the owner's tastes, what is required, what is unusual, what is uncertain, and what would make the event easy to rule in or out.

The second value prop is personal relevance triage. The owner is moderately skilled and generally avoids highly competitive events such as qualifiers or cEDH. Recurring positive signals include flexible social leagues, Commander and Cocktails, mystery or "unknown" events, personality-driven specials, and unusual Black Lotus opportunities. Lower-priority signals include routine ticketed drafts, ticketed precon events, highly competitive formats, or paid events that are not meaningfully special. These signals should de-emphasize events rather than erase them, and they should be explainable and reversible.

The third value prop is a commitment ladder before nonrefundable purchase. Natural states are Interested, Tentative, Committed, Purchased, Skipped, and later Attended. Interested means worth revisiting. Tentative means placed on the calendar to see consequences. Committed means a real decision, even if purchase has not yet happened. Purchased means entitlement evidence exists. Because ticketed play is often nonrefundable, Committed and Purchased items should have visibly stronger gravity than casual interest.

The fourth value prop is a contention map. Black Lotus programming, paid ticketed play, free events, random discoveries, meals, travel, hotel check-in/out, shopping windows, claim windows, and companion movements all compete for attention, but they should not all behave like identical calendar blocks. The app needs fixed-time versus flexible-time semantics. A league may have a listed time but remain playable during a broader window, so display time is not always blocking time. Likewise, Leap schedule placement is not entitlement: a purchased event removed from Leap's schedule may still be owned.

The app should therefore accommodate overlap instead of inheriting Leap's hard-overlap model. It should distinguish hard conflicts, soft conflicts, nonblocking flexible activities, tight transitions, and hidden costs such as having no meal break or more than two ticketed-play events in one day. Those human factors are useful as subtle planning texture, not as a prominent wellness or optimization subsystem.

Scarcity and change monitoring become much more important in this phase. Event diffs should eventually detect new events, removed events, sellouts, reopenings, price changes, time changes, location changes, duration changes, description changes, refunds, and cancellations. The meaning of a change depends on personal state: an unmarked sold-out event can stay quiet, an Interested sold-out event should be noted and grayed out, a Tentative or Committed sold-out event is more important, a Purchased sellout is usually not a problem, and a Purchased cancellation or refund is critical.

The MVP remains owner-managed, but person participation should be first-class. Kavi, Chris, and Juan can have interest, tentative, committed, purchased, ineligible, declined, or attended states without becoming app accounts. Owner relevance leads; group context informs. Future collaboration will be easier if event cards can show simple person chips with stable colors/faces/icons and state treatments, especially when comparing what Chris or Juan might want to do, but the app should not build voting or multi-user synchronization now.

Mobile access is mandatory, but mobile parity of dense planning layout is not. Complex event comparison and contention resolution may be better on desktop; the mobile surface still needs to let the owner inspect an event, change a planning state, see conflicts, and access critical purchased details. The data model and product thinking should support real complexity while letting each surface choose an appropriate density.

The interface should lean clickable and icon-literate without becoming decorative. Hearts, locks, tickets, alert badges, person chips, Black Lotus/VIP glyphs, and source/status icons can reduce reading load and make cards scannable. Online examples may inspire custom iconography, but project-owned or clearly licensed assets should be used rather than copied Magic art. Clickable real estate should reveal detail, rationale, source evidence, or a useful action whenever that expectation is natural.

### Cross-phase product insights

The app's repeated value is contextual retrieval. It should retrieve the right fact through the object the owner is thinking about, not through the source that originally published it. The owner should be able to think "Dragon Shield," "my Black Lotus pickup," "next event," "Prize Tix," or "shirts for Kellen" without remembering whether the fact lives in email, Leap, Magic Companion, a static map, the official app, a vendor announcement, or a receipt.

Milestones are the quiet-period landing spine. They are not chores; they are expected unlocks and readiness signals such as ticketed play, artists, Black Lotus store, store catalog, maps, prize wall, badge shipping, and late "Know Before You Go" information. A milestone should say what is being watched, why it matters, whether quiet is trustworthy, and what will happen when the information drops. If useful, it may include a clearly labeled historical timing clue or best rough guess derived from prior events, Gmail notices, news posts, or community observations. Speculation must remain lightweight, confidence-labeled, and subordinate to official evidence.

The app should help with MagicCon-specific friction, not ordinary adult logistics. Travel and hotel data are useful when they constrain the convention plan or provide quick reference. The app should not create generic packing, booking, budgeting, or "remember to install apps" nags unless a MagicCon-specific source, entitlement, timing issue, or selected plan makes the information consequential.

Robust preparation can support lightweight use. Artist matching may ingest artists, ManaBox exports, and card metadata, but should surface only a few easy signature opportunities if they exist. Store ingestion may OCR pages and images aggressively, but should present a pleasant catalog with favorite, hide, freshness, and source drawers. Prize wall tracking may retain availability observations, but Prize Tix should remain a simple Wallet asset with a tactile balance control. Deep intelligence is useful only when the visible experience stays proportional to the activity's real importance.

Places should become first-class enough to connect the event world. A place may be a room, booth, vendor, artist table, store, prize wall, pickup desk, lounge, meetup point, or approximate zone. Places can carry source observations, map references, personal interest, vendor exclusives, artist-card opportunities, notes, and upcoming events. This creates a path toward an aspirational interactive convention atlas: ingest official maps, OCR labels, preserve map versions, overlay clickable zones and points, and show personal markers such as next event, interested vendor, card-to-sign, Black Lotus/VIP, prize wall, or meetup. This is not MVP day-one, but early models should not reduce places to opaque text fields.

Store and merch are a legitimate over-ingestion target. Once the official or vendor catalog appears, the app should be allowed to become the owner's preferred reference surface while keeping canonical sources recoverable. Useful extraction includes product name, image, price, category, variants, limits, exclusivity, pickup rules, Black Lotus discount/window relevance, availability if observed, and source freshness. Personal state includes favorite, hidden, notes, maybe buy-for-person context, and later receipt reconciliation.

Prize Wall is a volatile redemption surface rather than a static catalog. Sold out does not always mean permanently gone, because daily refreshes may occur. The app should preserve availability observations with retrieval time and show freshness honestly: available as observed, sold out as observed, previously refreshed, check again later, stale, or unknown. The Prize Tix balance belongs in Wallet as a lightweight operational currency with quick manual adjustment, likely in 100-ticket increments, and may influence Prize Wall filters such as affordable, almost affordable, favorited, available, or check tomorrow. It should not become a full accounting subsystem.

Wallet is broader than credentials. It should hold operational artifacts and balances: badge/order references, Companion codes if captured, receipts, pickup proofs, discounts/entitlements, Prize Tix, and relevant showable originals. Each receipt or pickup artifact should preserve the original email/PDF/image/screenshot as-is, extracted structured facts where useful, and a freeform note such as "three of these shirts were for Kellen." Extracted data must never replace the original artifact when the original may need to be shown to a human.

During the event, the north star is "stop making me remember where the fact lives." The Now surface should bundle the next relevant object with time, place, source freshness, what to bring or show, and fallback artifacts. Some operational facts, especially Magic Companion table or seat assignment, may only become known shortly before play starts and may not be available to the app. The app should preserve upstream clues such as event title, Companion code, and any color-area wording if found, but treat them as coarse hints rather than final locations unless later evidence supports that.

Capture should be liberal but low-ceremony. Prefer contextual notes attached to meaningful objects over structured logging. Events, artists, vendors, store items, prize items, places, receipts, wallet items, and map observations should all have an easy notes surface. A Notes tab should default to human-authored notes and link every note back to its object. Activity logs are useful as optional machinery for power-user recovery, not as a default feed of every click.

Offline support should be prudent cache hygiene, not a redundancy platform. The PWA should cache the app shell and an offline-readable event pack containing recent Today/Now, itinerary, map images, place dictionary, wallet summaries, selected artifacts if allowed, store shortlist, prize wall snapshot, and notes. Offline should preserve confidence rather than create false certainty: stale data needs visible freshness, source monitoring stops offline, and writes should not silently overwrite server state.

Post-event use should be expected to drop sharply. Capture liberally, archive selectively, and retrieve deeply. Prominent post-event value is likely receipts and reimbursements, notes, signed-card outcomes if any, meaningful purchases, and lessons for next time. Ephemeral operational details such as Prize Tix balance changes, sold-out observations, and map lookup history can remain recoverable in logs but should fade from ordinary views. Design for retrieval after neglect, not a demanded reflection workflow.
