...
- `docs/PLAN_WORKSPACE_CONCEPT.md` now proposes a phase-sensitive but stable Plan workspace with Decide, Calendar, and Agenda modes. Decide owns candidate synthesis and contention sets, Calendar owns temporal layering and overlap, and Agenda owns chronological/mobile operation. This is a review candidate, not an approved screen.
...
No large data ingest, speculative comprehensive schema, production hosting, offline writes, or unreviewed agent promotion. Supabase remains canonical.
